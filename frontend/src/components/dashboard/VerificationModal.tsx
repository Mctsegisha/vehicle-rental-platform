...
export default function VerificationModal({ user, isOpen, targetOwnerId, onClose, onSuccess }: VerificationModalProps) {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>, field: 'idPhotoUrl' | 'licensePhotoUrl') => {
    ...
    // 1. Check size (5MB limit = 5242880 bytes)
  ...
  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center p-4 overflow-y-auto scroll-smooth">
      <div 
        ...
        onClick={onClose}
      />
      <div className="relative bg-dark-1 w-full max-w-xl rounded-xl shadow-2xl overflow-y-auto max-h-[90vh] md:max-h-[85vh] border border-white/5 animate-in fade-in zoom-in duration-300 custom-scrollbar scroll-smooth">
        <div className="p-6 sm:p-8 border-b border-white/5 flex items-center justify-between bg-white/5 sticky top-0 z-20 backdrop-blur-md bg-dark-1/95">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <div className="relative group">
                ...
                />
                <div className={`p-6 sm:p-10 border-2 border-dashed rounded-xl transition-all flex flex-col items-center justify-center gap-4 min-h-[140px] ${
