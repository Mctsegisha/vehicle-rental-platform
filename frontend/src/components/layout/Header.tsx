...
import { User, LogOut, Car, LayoutDashboard, KeyRound, Bell, Trash2, CheckCheck } from 'lucide-react';
          ...
          {user ? (
            <div className="flex items-center gap-4 pl-6 border-l border-white/10">
               ...
               <div className="relative" ref={dropdownRef}>
                 ...
                 {isNotificationsOpen && (
                   <div className="absolute right-0 mt-3 w-80 md:w-96 rounded-2xl border border-white/10 bg-dark-1/95 p-4 shadow-2xl backdrop-blur-xl z-50 animate-in fade-in slide-in-from-top-3 duration-200">
