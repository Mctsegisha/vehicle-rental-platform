      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg bg-dark-1 rounded-xl overflow-hidden shadow-2xl border border-white/5"
          >
            {/* Header */}
            <div className="p-8 border-b border-white/5 bg-white/5">
              <div className="flex justify-between items-start mb-2">
                <div>
                  <h2 className="text-2xl font-display font-black tracking-tight text-white uppercase mb-2">Payment</h2>
            ...
            <div className="p-8">
              {step === 'success' ? (
                <div className="py-12 text-center">
                  ...
                  <p className="text-muted font-medium px-8 text-xs leading-relaxed uppercase tracking-wider">Reference received. Payment verification is in progress. Your booking will be confirmed shortly.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmitPayment} className="space-y-6">
                  <div className="bg-dark-2 p-8 rounded-xl border border-white/5 shadow-inner">
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-4">
                              <div className={`w-12 h-12 rounded-lg flex items-center justify-center font-black text-xs shadow-2xl transition-transform duration-500 ${isSelected ? 'rotate-12 scale-110' : ''} ${
                                method === 'telebirr' ? 'bg-indigo-600 text-white shadow-indigo-600/20' :
                                method === 'cbe' ? 'bg-[#ff6b00] text-white shadow-orange-600/20' :
                                'bg-[#ffcc00] text-white shadow-yellow-600/20'
                              }`}>
                                {method === 'telebirr' ? 'TB' : method === 'cbe' ? 'CBE' : 'BOA'}
                              </div>
